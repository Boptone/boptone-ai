...
const menuItems = [
  ...
  { label: "My Music", path: "/releases" },
  { label: "Release Manager", path: "/releases/manager" },
  { label: "Distribution", path: "/distribution" },
  { label: "Batch Upload", path: "/batch-upload" },
...
export default function DashboardLayout({
  ...
  // Development mode: bypass authentication for seamless site navigation
