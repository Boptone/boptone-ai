          ...
          <CardContent className="p-8 md:p-12">
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="mb-4">
                  We use your information to operate our core platform features, including distributing your music to streaming platforms and distribution partners, tracking royalties across all revenue sources, processing micro-loan applications and managing loan repayments, operating your direct-to-fan merchandise store, detecting copyright infringement and protecting your intellectual property through AI-powered monitoring, managing tour planning and venue bookings, facilitating healthcare plan enrollment and benefits administration, providing comprehensive analytics dashboards, and enabling all other features described in our Terms of Service.
                </p>

                <h3 className="text-xl font-semibold mb-3 mt-6">3.3 AI and Machine Learning</h3>
                <p className="mb-4">
                  We use artificial intelligence and machine learning algorithms to analyze your data and provide intelligent features, including career optimization recommendations based on your performance metrics, trend forecasting to identify emerging opportunities, contract analysis to help you understand agreements, marketing automation to optimize your promotional campaigns, content generation for social media posts and promotional materials, infringement detection using audio fingerprinting and pattern recognition, predictive analytics for revenue forecasting and growth projections, risk assessment for micro-loan underwriting, personalized recommendations for collaborations and opportunities, and automated decision-making for certain platform features (with human oversight for significant decisions affecting your rights).
                </p>
