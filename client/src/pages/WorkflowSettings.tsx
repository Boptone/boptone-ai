    ...
    <div className="container py-12 max-w-5xl bg-gray-50">
      ...
      <Card className="mb-8 rounded-none border-4 border-black bg-white">
        ...
        <CardContent className="pt-6">
          ...
          >
            <SelectTrigger className="w-full rounded-none border border-gray-200 h-12 text-lg font-medium">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <Badge 
                            ...
                            className="rounded-none border border-gray-200 font-bold"
                          >
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          className="rounded-none border border-gray-200 hover:bg-gray-100"
                        >
                          {trigger.isActive ? "❚❚" : "▶"}
                        </Button>
                        <Button
              ...
              <CardContent className="space-y-6 pt-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={eventType} onValueChange={setEventType}>
                    <SelectTrigger id="eventType" className="rounded-none border border-gray-200 h-12 text-lg font-medium">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={comparison} onValueChange={setComparison}>
                    <SelectTrigger id="comparison" className="rounded-none border border-gray-200 h-12 text-lg font-medium">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent className="rounded-none border border-gray-200">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="rounded-none border border-gray-200 h-12 text-lg font-medium"
                  />
                  <p className="text-sm text-gray-600 font-medium">
                ...
                {/* Preview */}
                {eventType && threshold && (
                  <div className="bg-gray-100 p-4 rounded-none border border-gray-200">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Button
                    ...
                    className="rounded-none border border-gray-200 hover:bg-gray-100 font-bold px-6 py-3 text-lg"
                  >
                    Cancel
                  </Button>
                </div>
