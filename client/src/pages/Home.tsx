        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                size="lg" 
                className="rounded-full bg-[#008B8B] text-white hover:bg-[#006666] text-lg h-14 px-8 border border-black transition-colors"
                style={{
          ...
          <div className="text-center mb-12">
            ...
            <div className="flex items-center justify-center gap-4 mb-12">
              ...
              <button
                ...
                className="relative inline-flex h-8 w-14 items-center rounded-full bg-black transition-colors focus:outline-none focus:ring-2 focus:ring-[#008B8B] focus:ring-offset-2"
              >
                <span
              ...
              <span className={`text-base font-medium ${isAnnual ? 'text-black' : 'text-gray-500'}`}>
                Annual
                <span className="ml-2 text-[#008B8B] font-semibold">Save 20%</span>
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {tiers.map((tier, index) => (
              ...
              >
                  ...
                  {tier.monthlyPrice === 0 ? (
                    ...
                    <div>
                      ...
                      {isAnnual && savings(tier) > 0 && (
                        <div className="text-sm text-[#008B8B] font-semibold mt-1">
                ...
                <Button
                  size="lg"
                  className="w-full rounded-full bg-[#008B8B] text-white hover:bg-[#006666] border border-black transition-colors"
                  style={{
                    boxShadow: '4px 4px 0 0 black'
                  }}
                  onClick={() => {
