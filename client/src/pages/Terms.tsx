        ...
        <Card className="rounded-none border-4 border-black bg-white">
          <CardContent className="p-8 md:p-12">
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">12. AI-Powered Features and Chatbot</h2>
                
                <h3 className="text-xl font-semibold mb-3 mt-6">12.1 AI Chatbot Service</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">12.2 Acceptable Use of AI Features</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">12.3 AI-Generated Content</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">12.4 Data Processing and Privacy</h3>
                <p className="mb-4">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">13.2 Termination by Boptone</h3>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">18. Modifications to the Service and Terms</h2>
                <p className="mb-4">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">19.1 Entire Agreement</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">19.2 Waiver and Severability</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">19.3 Assignment</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">19.4 Force Majeure</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">19.5 No Third-Party Beneficiaries</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">19.7 Export Controls</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">19.8 California Users</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">19.9 International Use</h3>
                <p className="mb-4">
