      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">Article II: You Control Discovery</h3>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">Article III: AI Needs Your Permission</h3>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">Article IV: Humans Review Human Decisions</h3>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">Article V: Transparency Is Built In</h3>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">Article VI: You Can Leave Anytime (With Your Data)</h3>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">Article VII: We Protect Your Livelihood</h3>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">Article VIII: Questions Get Answers (From a Real Person)</h3>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">Article IX: Multi-Stakeholder Governance</h3>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">Article X: Enforcement and Accountability</h3>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">6. Service Features and Functionality</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">7. Subscription Plans and Payment Terms</h2>
                
                <h3 className="text-xl font-semibold mb-3 mt-6">7.1 Subscription Tiers</h3>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">7.2 Payment and Billing</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">7.3 Automatic Renewal</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">7.5 Transaction Fees</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">7.6 Payouts and Withdrawals</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">7.7 Payment Processing Services</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">7.8 Multi-Currency Transactions</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">7.9 Anti-Money Laundering (AML) and Know Your Customer (KYC) Compliance</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">7.10 Tax Obligations and Reporting</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">7.11 Refund Policies</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">7.12 Fraud Prevention and Dispute Resolution</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">7.13 Limitation of Liability for Payment Processing</h3>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h3 className="text-xl font-semibold mb-3 mt-6">7.14 Prohibited Products on BopShop</h3>
                <p className="mb-4">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">9.1 Boptone's Intellectual Property</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">9.2 Your Intellectual Property</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">9.3 License Grant to Boptone</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">9.4 DMCA and Copyright Infringement</h3>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">10. User Content Responsibilities</h2>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">11. Third-Party Services and Integrations</h2>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">13. AI-Powered Features and Chatbot</h2>
                
                <h3 className="text-xl font-semibold mb-3 mt-6">13.1 AI Chatbot Service</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">13.2 Acceptable Use of AI Features</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">13.3 AI-Generated Content</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">13.4 Data Processing and Privacy</h3>
                <p className="mb-4">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">14.1 Termination by You</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">14.2 Termination by Boptone</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">14.3 Effect of Termination</h3>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">15. Disclaimers and Warranties</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">18. Dispute Resolution and Arbitration</h2>
                <p className="mb-4  font-semibold">
                  PLEASE READ THIS SECTION CAREFULLY AS IT AFFECTS YOUR RIGHTS AND REQUIRES BINDING ARBITRATION OF DISPUTES.
                </p>

                <h3 className="text-xl font-semibold mb-3 mt-6">17.1 Informal Resolution</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">17.2 Binding Arbitration</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">17.3 Class Action Waiver</h3>
                <p className="mb-4  font-semibold">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">17.4 Exceptions</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">17.5 Governing Law</h3>
                <p className="mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold mb-4">19. Modifications to the Service and Terms</h2>
                <p className="mb-4">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">20.1 Entire Agreement</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">20.2 Waiver and Severability</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">20.3 Assignment</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">20.4 Force Majeure</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">20.5 No Third-Party Beneficiaries</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">20.6 Notices</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">20.7 Export Controls</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">20.8 California Users</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">20.9 International Use</h3>
                <p className="mb-4">
