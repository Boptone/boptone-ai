...
export async function createVerificationCode(
  ...
  try {
    ...
    // Delete any existing unverified codes for this identifier
    await db
...
export async function verifyCode(
  ...
  try {
    ...
    console.error("[Database] Failed to verify code:", error);
    throw error;
  }
}
...
export async function cleanupExpiredCodes(): Promise<void> {
  ...
  try {
    ...
    console.error("[Database] Failed to cleanup expired codes:", error);
  }
}
